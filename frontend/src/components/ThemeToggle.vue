<template><button @click="toggle" class="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700" :title="isDark?'切换浅色模式':'切换深色模式'">
...
<script setup>import { useTheme } from '../composables/useTheme'; const { isDark, toggle } = useTheme()</script>
